"""
organize_audio_files.py (gearbox_final_suite / data_processing)

Organizes raw WAV audio files from deep program directory into clean data/audio/ structure:
...
3. Standardized filenames: e.g., high_speed_20kph.wav, hills_6_degrees.wav, steering_pad.wav, etc.
...
def organize_audio_files():
    ...
    for filepath in audio_files:
        ...
        state = parts[-3].strip().lower() # normal or abnormal
        ...
        copied_count += 1
        print(f" [COPY] {filepath} -> {target_path}")
