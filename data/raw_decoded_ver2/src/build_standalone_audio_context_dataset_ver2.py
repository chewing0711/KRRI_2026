...
SUITE_DIR = os.path.dirname(os.path.dirname(VER2_ROOT))
GLOBAL_DATA_DIR = os.path.join(SUITE_DIR, "data")

RAW_DECODED_DIR = os.path.join(RESULTS_DIR, "raw_decoded")
AUDIO_LAUNCH_ALIGNED_DIR = os.path.join(GLOBAL_DATA_DIR, "audio_launch_aligned")
AUDIO_FILTERED_BPF_DIR = os.path.join(RESULTS_DIR, "audio_filtered_bpf")
...
def build_filtered_standalone_audio_dataset(window_size=34, step_size=34):
    ...
    csv_path_data = os.path.join(RESULTS_DIR, f"unified_audio_context_dataset_w{window_size}.csv")
